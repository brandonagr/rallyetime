...
namespace BoggleBot
{
    ...
    public class FastDictionaryTree
    {
        ...
        FDTNode[] _baseNodes = new FDTNode[26];
        ...
        public FastDictionaryTree()
        {
            for (char letter = 'a'; letter <= 'z'; letter++)
                _baseNodes[Util.Index(letter)] = new FDTNode();
        }
        ...
        public void AddWord(string word)
        {
            ...
            _baseNodes[Util.Index(word[0])].AddToChildren(word.Substring(1));
        }
        ...
        private void PrintTree(TextWriter wr)
        {
            ...
            foreach (FDTNode node in _baseNodes)
            {
                curWord.Push(letter);
                PrintTreeRecurse(node, curWord, wr);
                curWord.Pop();
                letter++;
            }
        }
